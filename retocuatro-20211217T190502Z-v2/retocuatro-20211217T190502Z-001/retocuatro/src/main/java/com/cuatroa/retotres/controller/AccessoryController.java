...
public class AccessoryController {
    ...
    public Optional<Accessory> getAccesorybyprice(@PathVariable("price") String price) {
        return accessoryService.getAccesorybyprice(price);
    }
    
    @GetMapping("/description/{destription}")                                   
    public Optional<Accessory> getAccesorybydescription(@PathVariable("description") String description) {
        return accessoryService.getAccesorybydescription(description);
    }
}
