...
public class AccessoryService {
    ...
    public Optional<Accessory> getAccesorybyprice(String price) {
        return accesoryRepository.getAccesorybyprice(price);
    }
    
    public Optional<Accessory> getAccesorybydescription(String description) {
        return accesoryRepository.getAccesorybydescription(description);
    }
